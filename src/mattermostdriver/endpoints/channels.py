...
class Channels(Base):
    ...
    def get_list_of_channels_by_ids(self, team_id, options=None):
        return self.client.post(
            Teams.endpoint + "/" + team_id + "/channels/ids", options=options
        )
    ...
    def patch_channel(self, channel_id, options):
        return self.client.put(
            self.endpoint + "/" + channel_id + "/patch", options=options
        )
    ...
    def get_channel_members(self, channel_id, params=None):
        return self.client.get(
            self.endpoint + "/" + channel_id + "/members", params=params
        )

    def add_user(self, channel_id, options=None):
        return self.client.post(
            self.endpoint + "/" + channel_id + "/members", options=options
        )

    def get_channel_members_by_ids(self, channel_id, options=None):
        return self.client.post(
            self.endpoint + "/" + channel_id + "/members/ids", options=options
        )
    ...
    def view_channel(self, user_id, options):
        return self.client.post(
            self.endpoint + "/members/" + user_id + "/view", options=options
        )
    ...
    def search_channels(self, team_id, options=None):
        return self.client.post(
            "/teams/" + team_id + "/channels/search", options=options
        )

    def autocomplete_channels(self, team_id, params=None):
        return self.client.get(
            "/teams/" + team_id + "/channels/autocomplete", params=params
        )

    def update_scheme_derived_roles_of_channel_member(
        self, channel_id, user_id, options=None
    ):
        return self.client.put(
